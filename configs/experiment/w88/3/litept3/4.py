...
wandb_run_name = f"LitePT {exp_group}.{num_exp}) eff_bs={batch_size} & point_max={point_max} | harmonized transforms | lr={lr} | grid_size={grid_size} | warmup_steps={warmup_steps} | input=RGB"
