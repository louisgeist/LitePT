...
wandb_run_name = f"LitePT {num_exp}) lab6 | eff_bs={batch_size} & point_max={point_max} | harmonized transforms | lr={lr} | grid_size={grid_size} | warmup_steps={warmup_steps}"
